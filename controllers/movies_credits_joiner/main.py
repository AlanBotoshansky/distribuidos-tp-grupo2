...
from src.movies_credits_joiner import MoviesCreditsJoiner
import logging
import os
import ast
...
def main():
    ...
    movies_credits_joiner = MoviesCreditsJoiner(input_queues, output_exchange, cluster_size, id)
    movies_credits_joiner.run()
