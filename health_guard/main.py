...
from src.health_guard import HealthGuard
import logging
import os
import ast
...
def initialize_config():
    ...
    try:
        ...
        config_params["health_check_port"] = int(os.getenv('HEALTH_CHECK_PORT', config["DEFAULT"]["HEALTH_CHECK_PORT"]))
...
def main():
    ...
    health_check_port = config_params["health_check_port"]
